...
namespace ExpressionToString.Tests.Constructed {
    ...
    public class MakeBinary {
        ...
        [Fact]
        public void ConstructReferenceEqual() => RunTest(ReferenceEqual(lst, lst), "lst == lst", "lst Is lst");

        [Fact]
        public void ConstructReferenceNotEqual() => RunTest(ReferenceNotEqual(lst, lst), "lst != lst", "lst IsNot lst");
