...
namespace ExpressionToString.Tests {
    public abstract class TestsBase {
        protected void RunTest(Expression<Action> expr, string csharp, string vb) => RunTest(expr as Expression, csharp, vb);
        ...
        protected abstract void RunTest(object o, string csharp, string vb);
    }
}
